...
Drop table coupon_batch cascade;
Drop table issued_coupon cascade;
Drop table orders cascade;
Drop table orderline cascade;
Drop table comment cascade;
Drop table review cascade;
Drop table review_version cascade;
Drop table reply cascade;
Drop table reply_version cascade;
Drop table employee cascade;
Drop table refund_request cascade;
Drop table complaint cascade;
Drop table shop_complaint cascade;
Drop table comment_complaint cascade;
Drop table delivery_complaint cascade;
